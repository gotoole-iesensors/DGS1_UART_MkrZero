...
void setup() 
{
  ...
  Serial.println("Enter 'A' to enter running average(1-180 samples), SPS(1-768), Interval between measurements(1, 5, 10, 15)");
  ...
  Serial.println("Enter 'P' to st LMP91000 potentiostat settings");
  ...
  Serial.println("Enter 'N' to set temperature compensation factor (Enter 0 for automatic adjustment)");
